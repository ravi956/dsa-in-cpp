// This algorithm is used to find the strongly conn comp in directed graph
...
class Graph
{
    ...
    // A recursion function to print DFS starting from v
...
void Graph::fillOrder(int v, bool visited[], stack<int> &Stack)
{
    ...
    // All vertices reachable from v are procesed by now , push v
    Stack.push(v);
}

// The main function that finds and prnts all SCCs
